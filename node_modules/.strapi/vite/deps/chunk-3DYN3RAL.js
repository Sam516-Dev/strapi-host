...
import {
  LimitsModal
} from "./chunk-IZ7JNRP2.js";
import {
  useTypedSelector
} from "./chunk-QDRWIVWA.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-F2KTWNR2.js";
import {
  getStageColorByHex
} from "./chunk-RCFEUAJJ.js";
import {
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-DJ6W6T2E.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-BQPNBIOA.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-RXJOOY4U.js";
import {
  useConfig
} from "./chunk-EYGZASIW.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-AKKTNIHX.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-JB5SIVEN.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-FT43L4H2.js";
import {
  renderAdmin
} from "./chunk-EQB66K67.js";
import {
  useLicenseLimits
} from "./chunk-CEYWWE4S.js";
import {
  Table,
  useTable
} from "./chunk-ELXW6ZNB.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-7FN4Z75X.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-KODFQI3N.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-FI4KXD2U.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-G4L2RYNP.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-W2QTUEML.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-RKW4XDAE.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-GSXVCJYI.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-5YDDK3NW.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-MZZCWVMN.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-C5YWJVE6.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-HLDII57F.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-FAIBRS64.js");
          return {
...
//# sourceMappingURL=chunk-3DYN3RAL.js.map
